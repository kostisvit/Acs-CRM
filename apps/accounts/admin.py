...
class CustomUserAdmin(ImportExportModelAdmin):
    ...
    list_display = ('id','email','display_company', 'first_name', 'last_name','job_title', 'is_staff', 'is_active','created','modified')
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('first_name', 'last_name', 'email','job_title','days_sum','days_left','is_superuser','is_staff','is_active','phone_number','groups', 'user_permissions')}
        ),
    )
    search_fields = ('email',)
    ordering = ('email',)
